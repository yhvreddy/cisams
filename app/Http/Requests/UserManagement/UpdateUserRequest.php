    ...
    public function rules(): array
    {
        return [
            ...
            'email' => [
                'required',
                'email',
                'unique:users,email,' . $this->user->id, // Unique in the users table's email column
            ],
            'username' => [
                'required',
                'alpha_num', // Only alphanumeric characters
                'unique:users,username,'.$this->user->id, // Unique in the users table's username column
            ],
            'mobile' => [
                'nullable',
