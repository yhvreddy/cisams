    ...
    <div class="row mt-1 mb-4">
        <form method="POST" action="{{ route('user-management.update', ['user' => $user->id]) }}"
            ...
            <div class="mt-2 form-group">
                ...
                <input type="text" class="form-control text" value="{{ old('name') ?? $user->name }}" required
            ...
            <div class="mb-2 form-group">
                ...
                <input type="email" class="form-control email" value="{{ old('email') ?? $user->email }}" required
            ...
            <div class="mb-2 form-group">
                ...
                <input type="text" class="form-control text-id" readonly required name="username" id="UserName"
            ...
            <div class="mb-2 form-group">
                ...
                <input type="text" class="form-control number" value="{{ old('mobile') ?? $user->mobile }}"
            ...
            <div class="mb-2 form-group">
                ...
                <select class="form-control" name="status" id="Status" required>
                    @foreach ($status as $sts)
                        <option value="{{ $sts }}" {{ $user->status == $sts ? 'selected' : '' }}>
                            {{ $sts }}
                        </option>
                    @endforeach
                </select>
