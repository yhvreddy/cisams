...
@section('title', $listName . ' - District Graph | FIR Conversions')
...
@section('content')
    @include('pages.fir-conversions.components.header-title', [
        'title' => $listName . ' - District Graph | FIR Conversions',
    ])
    ...
    <div class="row mt-1">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const districtLabels = @json($labels); // Dynamic labels
                const districtData = @json($casesData); // Dynamic data
                const districtLinks = @json($districtWiseUrls); // Dynamic links
